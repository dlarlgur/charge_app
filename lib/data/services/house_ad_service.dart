...
class AdSlotResolver {
  ...
  // 4 간격 14자리(4,8,…,56) — list_banner1~14 unit ID (ad_service.dart).
  // house 광고를 이 자리에 등록 + bypass 켜면 AdMob 대신 house 노출.
  static const Set<int> admobSlots = {
